...
public class ScopeFilterTest extends AbstractArtifactFilterTest {
    ...
    public void testScopeFilterExclude() {
        ...
        final ScopeFilter tools = new ScopeFilter("", comSunTools.getScope());
    ...
    @Test
    public void testScopeFilterInclude() {
        // given
        final Dependency comSunTools = COM_SUN_TOOLS_SYSTEM_JAR;
        final Dependency mavenArtifact = MAVEN_ARTIFACT_COMPILE_JAR;
        final ScopeFilter tools = new ScopeFilter(mavenArtifact.getScope(), "");
    ...
    @Test
    public void testScopeFilterIncludeRuntime() {
        final Dependency comSunTools = COM_SUN_TOOLS_SYSTEM_JAR;
        final Dependency mavenArtifact = MAVEN_ARTIFACT_COMPILE_JAR;
        final ScopeFilter tools = new ScopeFilter("runtime", "");
        final HashSet<Dependency> dependencies = new HashSet<>(2);
        dependencies.add(comSunTools);
        dependencies.add(mavenArtifact);
